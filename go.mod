...
require (
	...
	github.com/eclipse-iofog/iofog-go-sdk/v2 v2.0.0-beta2.0.20200407042039-4c7e1fb98f6b
	github.com/eclipse-iofog/iofog-operator/v2 v2.0.0-20200422215211-6f4f30fc36a2
