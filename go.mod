...
require (
	...
	github.com/eclipse-iofog/iofog-go-sdk/v2 v2.0.0-alpha.0.20200322230005-d4324d091ca8
	github.com/eclipse-iofog/iofog-operator/v2 v2.0.0-20200320033252-b31517dcba0c
