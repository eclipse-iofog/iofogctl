...
require (
	...
	github.com/eclipse-iofog/iofog-go-sdk/v2 v2.0.0-alpha.0.20200331011241-a95d16e765a7
	github.com/eclipse-iofog/iofog-operator/v2 v2.0.0-20200327003721-a522571f4b83
