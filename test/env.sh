...
export AGENT_IMAGE='gcr.io/focal-freedom-236620/agent:3.0.0-beta7'
...
export OPERATOR_IMAGE='gcr.io/focal-freedom-236620/operator:3.0.0-beta5'
...
export AGENT_VANILLA_VERSION='3.0.0-beta7'
