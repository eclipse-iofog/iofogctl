## iofogctl nats users create-mqtt-bearer

Create MQTT bearer NATS user

```
iofogctl nats users create-mqtt-bearer APP_NAME USER_NAME [flags]
```
...
```
  ...
  -h, --help               help for create-mqtt-bearer
