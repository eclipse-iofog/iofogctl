...
func TestGoldenUnmarshalRemoteAgentPackageRegistry(t *testing.T) {
	...
	require.Equal(t, "1.0.0-rc.6", agent.Package.Version)
	require.Equal(t, "ghcr.io/datasance/edgelet:1.0.0-rc.6", agent.Package.Container.Image)
	...
	require.Equal(t, []string{"1.0.0-rc.6"}, agent.Scripts.Install.Args)
