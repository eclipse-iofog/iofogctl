...
require (
	...
	github.com/eclipse-iofog/iofog-go-sdk/v2 v2.0.0-beta3.0.20200512221332-c49ad73a6379
	github.com/eclipse-iofog/iofog-operator/v2 v2.0.0-20200506020941-de41f683215e
