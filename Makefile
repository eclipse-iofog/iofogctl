...
LDFLAGS += -X $(PREFIX).controllerTag=1.3.0-rc3 -X $(PREFIX).connectorTag=1.3.0-rc1 -X $(PREFIX).kubeletTag=1.3.0-rc2 -X $(PREFIX).operatorTag=1.3.0-rc2 -X $(PREFIX).agentTag=1.3.0-rc1 -X $(PREFIX).schedulerTag=0.0.0
REPORTS_DIR ?= reports
