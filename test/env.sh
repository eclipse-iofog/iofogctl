...
#export CONTROLLER_IMAGE="gcr.io/focal-freedom-236620/controller:1.3.0-rc3"
#export CONNECTOR_IMAGE="gcr.io/focal-freedom-236620/connector:1.3.0-rc1"
#export OPERATOR_IMAGE="gcr.io/focal-freedom-236620/operator:1.3.0-rc2"
#export KUBELET_IMAGE="gcr.io/focal-freedom-236620/kubelet:1.3.0-rc1"
export CONTROLLER_IMAGE="iofog/controller:1.3.0-rc3"
export CONNECTOR_IMAGE="iofog/connector:1.3.0-rc1"
export OPERATOR_IMAGE="iofog/iofog-operator:1.3.0-rc2"
export KUBELET_IMAGE="iofog/iofog-kubelet:1.3.0-rc2"
